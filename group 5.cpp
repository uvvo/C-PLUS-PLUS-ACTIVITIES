...
setDisplay(resultArray,resultArraySize);
            ...
            //Differnce A-B
void SetOperations::set_Difference(int *universalArray,int universalArraySize,int *secondArray,int secondArraySize)
{
   int i,j,flag=0,resultArray[20],resultArraySize=0;
   ...
   for(j=0;j<secondArraySize;j++)
   {
      if(universalArray[i]==secondArray[j])
   {
   flag=1;
   break;
   }
   ...
   if(flag==0)
   { 
   resultArray[resultArraySize]=universalArray[i];
   resultArraySize++;
   }
} 
setDisplay(resultArray,resultArraySize);
          ...
          //Difference Sets B-A
void SetOperations::set__Difference(int *universalArray,int universalArraySize,int *firstArray,int firstArraySize)
{
   int i,j,flag=0,resultArray[20],resultArraySize=0;
   ...
   for(j=0;j<firstArraySize;j++)
   {
      if(universalArray[i]==firstArray[j])
   {
   flag=1;
   break;
   }
...
setDisplay(resultArray,resultArraySize);
       ...
       //Complement 'A
void SetOperations::set_Complement(int *universalArray,int universalArraySize,int *firstArray,int firstArraySize)
{
   int i,j,flag=0,resultArray[20],resultArraySize=0;
...
setDisplay(resultArray,resultArraySize);
          ...
          //Complement 'A
void SetOperations::set__Complement(int *universalArray,int universalArraySize,int *secondArray,int secondArraySize)
{
   int i,j,flag=0,resultArray[20],resultArraySize=0;
